            ...
            <main>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="hero-inner-content">
                                        <h1 className="title">Green up Your Space into nature</h1>
                                        <p className="details">
                                        ...
                                        <div className="category-inner-cart">
                                            <figure>
                                                <img
                                                    ...
                                                    src="/assets/images/home/Succulents.png"
                                                    alt="img"
                                                />
                                            </figure>
                                            <p className="category-name">Succulents</p>
                                        </div>
                                    </Link>
                                </div>
                                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <Link href="./product-details.html">
                                        <div className="category-inner-cart">
                                            <figure>
                                                <img
                                                    className="category-img"
                                                    src="/assets/images/home/Carnivorous.png"
                                                    alt="img"
                                                />
                                            </figure>
                                            <p className="category-name">Carnivorous</p>
                                        </div>
                                    </Link>
                                </div>
                                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <Link href="./product-details.html">
                                        <div className="category-inner-cart">
                                            <figure>
                                                <img
                                                    className="category-img"
                                                    src="/assets/images/home/Flowering Plants.png"
                                                    alt="img"
                                                />
                                            </figure>
                                            <p className="category-name">Flowering Plants</p>
                                        </div>
                                    </Link>
                                </div>
                                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <Link href="./product-details.html">
                                        <div className="category-inner-cart">
                                            <figure>
                                                <img
                                                    className="category-img"
                                                    src="/assets/images/home/Foliage Plants.png"
                                                    alt="img"
                                                />
                                            </figure>
                                            <p className="category-name">Foliage Plants</p>
                                        </div>
                                    </Link>
                                </div>
                                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <Link href="./product-details.html">
                                        <div className="category-inner-cart">
                                            <figure>
                                                <img
                                                    className="category-img"
                                                    src="/assets/images/home/Bonsai Plants.png"
                                                    alt="img"
                                                />
                                            </figure>
                                            <p className="category-name">Bonsai Plants</p>
                                        </div>
                                    </Link>
                                </div>
                                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <Link href="./product-details.html">
                                        <div className="category-inner-cart">
                                            <figure>
                                                <img
                                                    className="category-img"
                                                    src="/assets/images/home/Herbs Plants.png"
                                                    alt="img"
                                                />
                                            </figure>
                                            <p className="category-name">Herbs Plants</p>
                                        </div>
                                    </Link>
                                </div>
                            </div>
                                            ...
                                            <div className="popularProduct-inner-cart">
                                                <figure className="popularProduct-inner-cart-image">
                                                    <img
                                                        ...
                                                        src="/assets/images/home/popularProduct-bg-1.png"
                                                        alt="popularProduct"
                                                    />
                                                    ...
                                                    <div className="popularProduct-inner-cart-inner">
                                                        <div className="popularProduct-inner-cart-hover">
                                                            <figure className="cart-hover-bg">
                                                                <img
                                                                    src="/assets/images/home/shopping.png"
                                                                    alt="shopping"
                                                                />
                                                            </figure>
                                                            <figure className="cart-hover-bg">
                                                                <img
                                                                    src="/assets/images/home/favourite.png"
                                                                    alt="favourite"
                                                                />
                                                            </figure>
                                                            <figure className="cart-hover-bg">
                                                                <img
                                                                    src="/assets/images/home/View.png"
                                                                    alt="View"
                                                                />
                                                            </figure>
                                                        </div>
                                                ...
                                                <div className="popularProduct-inner-cart-content">
                                                    <div className="title line-clamp1">
                                        ...
                                        <Link href="./product-details.html" className="d-block">
                                            <div className="popularProduct-inner-cart">
                                                <figure className="popularProduct-inner-cart-image">
                                                    <img
                                                        className="product-img"
                                                        src="/assets/images/home/popularProduct-bg-2.png"
                                                        alt="popularProduct"
                                                    />
                                                    <div className="new">New</div>
                                        ...
                                        <Link href="./product-details.html" className="d-block">
                                            <div className="popularProduct-inner-cart">
                                                <figure className="popularProduct-inner-cart-image">
                                                    <img
                                                        className="product-img"
                                                        src="/assets/images/home/popularProduct-bg-3.png"
                                                        alt="popularProduct"
                                                    />
                                                    <div className="new">New</div>
                                        ...
                                        <Link href="./product-details.html" className="d-block">
                                            <div className="popularProduct-inner-cart">
                                                <figure className="popularProduct-inner-cart-image">
                                                    <img
                                                        className="product-img"
                                                        src="/assets/images/home/popularProduct-bg-4.png"
                                                        alt="popularProduct"
                                                    />
                                                    <div className="new">New</div>
                                        ...
                                        <Link href="./product-details.html" className="d-block">
                                            <div className="popularProduct-inner-cart">
                                                <figure className="popularProduct-inner-cart-image">
                                                    <img
                                                        className="product-img"
                                                        src="/assets/images/home/popularProduct-bg-5.png"
                                                        alt="popularProduct"
                                                    />
                                                    <div className="new">New</div>
                                        ...
                                        <Link href="./product-details.html" className="d-block">
                                            <div className="popularProduct-inner-cart">
                                                <figure className="popularProduct-inner-cart-image">
                                                    <img
                                                        className="product-img"
                                                        src="/assets/images/home/popularProduct-bg-6.png"
                                                        alt="popularProduct"
                                                    />
                                                    <div className="new">New</div>
                                        ...
                                        <Link href="./product-details.html" className="d-block">
                                            <div className="popularProduct-inner-cart">
                                                <figure className="popularProduct-inner-cart-image">
                                                    <img
                                                        className="product-img"
                                                        src="/assets/images/home/popularProduct-bg-7.png"
                                                        alt="popularProduct"
                                                    />
                                        ...
                                        <Link href="./product-details.html" className="d-block">
                                            <div className="popularProduct-inner-cart">
                                                <figure className="popularProduct-inner-cart-image">
                                                    <img
                                                        className="product-img"
                                                        src="/assets/images/home/popularProduct-bg-8.png"
                                                        alt="popularProduct"
                                                    />
                                                    <div className="new">New</div>
                            ...
                            <div className="plantHome-inner">
                                <div className="row g-5">
                                    <div className="col-md-6">
                                        <figure>
                                            <img
                                                className="plantHome-inner-imge"
                                                src="/assets/images/home/plant-office.png"
                                                alt="imge"
                                            />
                                        </figure>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="plantHome-inner-content">
                                            ...
                                            <p className="plantHome-inner-content-details">
                                                ...
                                                mattis. className aptent taciti sociosqu ad litora
                                                torquent per.
                                            </p>
                                            <div>
                                                <Link href="/shop" className="primary-button">
                                ...
                                <div className="row g-5">
                                    ...
                                    <div className="col-md-6">
                                        <figure>
                                            <img
                                                className="plantHome-inner-imge"
                                                src="/assets/images/home/plant-home.png"
                                                alt="imge"
                                            />
                                        </figure>
                                    </div>
                ...
                <section>
                    <div className="inner-recentBlock">
                        <div className="container">
                            <h1 className="section-header">Read Our Recent Blogs</h1>
                            <p className="section-description">
                                Gorem ipsum dolor sit amet, consectetur adipiscing elit dolor
                                sit amet
                            </p>
                                        ...
                                        <div className="blog-cart">
                                            ...
                                            <div className="blog-cart-content">
                                                <h1 className="blog-title line-clamp2">
                                                    How to choose best plant for you that makes your house
                                                    design better
                                                </h1>
                                                <div className="blog-author">
                                                    <p className="author-name">By Akash Basak</p>
                                                    <p className="publish-date">10 june 2024</p>
                                                </div>
                                            </div>
                                        </div>
                                    </Link>
