                                                    ...
                                                    <button className="delate-btn">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="#64748B" stroke-width="1.5" strokeLinecap="round" />
                                                            <path
                                                                d="M3 5.5H21M16.0557 5.5L15.3731 4.09173C14.9196 3.15626 14.6928 2.68852 14.3017 2.39681C14.215 2.3321 14.1231 2.27454 14.027 2.2247C13.5939 2 13.0741 2 12.0345 2C10.9688 2 10.436 2 9.99568 2.23412C9.8981 2.28601 9.80498 2.3459 9.71729 2.41317C9.32164 2.7167 9.10063 3.20155 8.65861 4.17126L8.05292 5.5"
                                                                stroke="#64748B" stroke-width="1.5" strokeLinecap="round" />
                                                            <path d="M9.5 16.5V10.5" stroke="#64748B" stroke-width="1.5" strokeLinecap="round" />
                                                            <path d="M14.5 16.5V10.5" stroke="#64748B" stroke-width="1.5" strokeLinecap="round" />
                                                        </svg>
                                                    </button>
                                                </div>
                                            </div>
